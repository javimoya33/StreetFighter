...
var w = canvas1.width = canvas2.width = canvas3.width = 1024;
var h = canvas1.height = canvas2.height = 576;
canvas3.height = 275;
window.addEventListener('resize', function() {
  w = canvas1.width = canvas2.width = canvas3.width = 1024;
  h = canvas1.height = canvas2.height = 576;
  canvas3.height = 275;
});
